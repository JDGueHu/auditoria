			...
			<tbody>
				@foreach($tiposDocumento as $tipoDocumento)
					<tr>
						...
						@if($tipoDocumento->alive)
							<td><span class="label label-success">Activo</span></td>
						@else
							<td><span class="label label-danger">Inactivo</span></td>
						@endif
						<td>
							<a data-toggle="tooltip" data-placement="top" title="Detalles" href="{{ route('tiposDocumento.show',$tipoDocumento->id) }}" class="btn btn-default btn-xs">
								<i class="fa fa-eye" aria-hidden="true"></i>
							</a>
							<a data-toggle="tooltip" data-placement="top" title="Editar" href="{{ route('tiposDocumento.edit',$tipoDocumento->id) }}" class="btn btn-warning btn-xs">
