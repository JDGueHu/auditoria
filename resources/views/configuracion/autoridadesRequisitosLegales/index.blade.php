				...
				@foreach($tiposAutoridades as $tiposAutoridad)
					<tr>
						...
						<td>
							...
							<a data-toggle="tooltip" data-placement="top" title="Eliminar" href="{{ route('autoridadRequisitoLegal.destroy',$tiposAutoridad->id) }}" class="btn btn-danger btn-xs confirm_F">
