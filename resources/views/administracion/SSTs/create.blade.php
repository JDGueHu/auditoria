...
{!! Form::open(['route' => 'SST.store', 'method' => 'POST', 'id' => 'createVacaciones']) !!} 
    ...
    <div class="panel-body">
        ...
        <div class="row">  
            <div class="col-md-6 separarBottom">
                ...
                {!! Form::select('causaPrincipal_id', $causasSSt_principales, null, ['class' => 'form-control', 'placeholder' => 'Seleccione tipo de SST','id'=>'causaPrincipal_id','required'])  !!} 
            ...
            <div class="col-md-6 separarBottom">
                ...
                {!! Form::select('causaComplementaria_id', $causasSSt_complementarias, null, ['class' => 'form-control', 'placeholder' => 'Seleccione tipo de SST','id'=>'causaComplementaria_id','required'])  !!} 
